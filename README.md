<img width="1000px" height="300px" src="./Studio.png">
...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=py,django,mongodb,express,react,nodejs,typescript,java,next,firebase,mysql,postgres,sqlite,prisma,vite,tailwind,html,css,js,discordjs,discord,figma,graphql,vercel,md,ubuntu,vscode,neovim,git,npm,docker&theme=dark)](https://skillicons.dev)
