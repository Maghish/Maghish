...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=py,django,mongodb,express,react,nodejs,typescript,next,firebase,mysql,postgres,sqlite,vite,tailwind,html,css,js,discordjs,discord,bots,figma,graphql,vercel,md,ubuntu,vscode,neovim,git,npm,docker&theme=dark)](https://skillicons.dev)
